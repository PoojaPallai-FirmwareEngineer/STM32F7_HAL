...
int main(void)
{
    ...
    uint8_t last_buttonstatus = GPIO_PIN_RESET; // Released Initially
    ...
    while(1)
    {
        ...
        if(buttonstatus == GPIO_PIN_RESET && last_buttonstatus == GPIO_PIN_SET)
        {
        	// Toggle all LEDS
        ...
        last_buttonstatus = buttonstatus;
